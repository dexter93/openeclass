...
$langTeacher = "Καθηγητής";
$langOfTeacher = "Καθηγητή";
$langTeachers = "Καθηγητές";
$langOfTeachers = "Καθηγητών";

$langsTeacher = "καθηγητής";
$langsOfTeacher = "καθηγητή";
$langsTeachers = "καθηγητές";
$langsOfTeachers = "καθηγητών";

$langStudent = "Φοιτητής";
$langOfStudent = "Φοιτητή";
$langStudents = "Φοιτητές";
$langOfStudents = "Φοιτητών";

$langsStudent = "φοιτητής";
$langsOfStudent = "φοιτητή";
$langsStudents = "φοιτητές";
